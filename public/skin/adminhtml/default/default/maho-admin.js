...
class AdminNavController extends Controller {
    connect() {
        ...
        // 3. All levels: click to toggle open, accordion closes siblings
        this.element.querySelectorAll('#nav li.parent > a').forEach(link => {
            link.addEventListener('click', e => {
                ...
                // Accordion: close other open siblings at same level
                if (!isOpen) {
